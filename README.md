...
<div align="center">
  ...
  <h2>🚀 What's New</h2>
  <p><strong>v0.2.6.11 evidence-first validation</strong> · validate now audits official validator evidence instead of failing on safe command-environment adjustments</p>
