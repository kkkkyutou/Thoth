...
<div align="center">
  ...
  <p>
    ...
    <img alt="Version 0.2.3" src="https://img.shields.io/badge/version-0.2.3-4B5563?style=flat-square&labelColor=3F3F46&color=0369A1" />
    <img alt="License MIT" src="https://img.shields.io/badge/license-MIT-4B5563?style=flat-square&labelColor=3F3F46&color=84CC16" />
  </p>
  <h2>🚀 What's New</h2>
  <p><strong>v0.2.3 patch release</strong> · compact work-item authority with <code>work_id</code> · Claude Code and Codex plugin parity</p>
