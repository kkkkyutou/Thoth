...
const STYLE_ID = "thoth-ui-font";
const RULE = "#root *:not([data-pmono]):not([data-pmono] *){font-family:var(--thoth-ui-font);}";
...
export function applyRootUiFont(uiFontStack: string): void {
  ...
  document.documentElement.style.setProperty("--thoth-ui-font", value);
