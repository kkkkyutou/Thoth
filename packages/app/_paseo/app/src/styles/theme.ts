...
import { darkHighlightColors, lightHighlightColors } from "@thoth/highlight";
...
// Thoth — subtle teal-green tint (default)
const thothDarkColors = buildDarkSemanticColors({
  surface0: "#181B1A",
  surface1: "#1E2120",
  surface2: "#272A29",
  surface3: "#434645",
...
export const darkTheme = buildDarkTheme(thothDarkColors);
