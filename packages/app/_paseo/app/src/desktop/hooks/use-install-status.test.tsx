...
describe("useCliInstall", () => {
  ...
  it("toasts and exposes CLI install errors", async () => {
    ...
    expect(toast.error).toHaveBeenCalledWith("Unable to install the Thoth CLI.");
  ...
  it("uses the active language for CLI install errors", async () => {
    ...
    expect(toast.error).toHaveBeenCalledWith("无法安装 Thoth CLI。");
  });
});
