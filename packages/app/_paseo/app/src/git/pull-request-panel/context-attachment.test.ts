...
function comment(overrides: Partial<PrPaneActivity> = {}): PrPaneActivity {
  return {
    ...
    body: "Looks good.",
    age: "3d ago",
    url: "https://github.com/thoth/thoth/pull/42#issuecomment-1",
    ...overrides,
  };
}
  ...
  it("formats a comment as a workspace context attachment", () => {
    expect(
      ...
      text: [
        ...
        "Pull request URL: https://github.com/thoth/thoth/pull/42",
        "URL: https://github.com/thoth/thoth/pull/42#issuecomment-1",
        "Author: octocat",
        "Created: 3d ago",
  ...
  it("formats failed check details as a workspace context attachment", () => {
    expect(
      ...
      text: [
        ...
        "Status: failure",
        "Conclusion: failure",
        "Check URL: https://github.com/thoth/thoth/actions/runs/456/job/789",
        "Details URL: https://github.com/thoth/thoth/actions/runs/456/job/789",
        ...
        "Failed jobs:",
        "- test: failure",
        "  https://github.com/thoth/thoth/actions/runs/456/job/789",
        "  ```",
        "  last line",
        "  ```",
        "",
  ...
  it("formats metadata-only failed check context when details are unavailable", () => {
    expect(
      buildPullRequestCheckContextAttachment({
        ...
        check: check({
          name: "status/context",
          url: "https://github.com/thoth/thoth/status/context",
          github: undefined,
        }),
        githubDetails: null,
      }),
      ...
      text: [
        ...
        "Status: failure",
        "Check URL: https://github.com/thoth/thoth/status/context",
      ].join("\n"),
    });
  });
});
    ...
    return {
      ...
      comments: [
        comment({
          ...
          url: "https://github.com/thoth/thoth/pull/42#discussion_r1",
        }),
