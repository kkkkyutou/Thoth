...
declare global {
  interface Window {
    ...
    __THOTH_TERMINAL_WEBVIEW_RECEIVE__?: (message: InboundMessage) => void;
    __THOTH_TERMINAL_WEBVIEW_BLUR__?: () => void;
  }
}
...
const TERMINAL_BACKGROUND_CSS_VAR = "--thoth-terminal-background";
...
window.__THOTH_TERMINAL_WEBVIEW_RECEIVE__ = bridge.receive;
window.__THOTH_TERMINAL_WEBVIEW_BLUR__ = bridge.blur;
