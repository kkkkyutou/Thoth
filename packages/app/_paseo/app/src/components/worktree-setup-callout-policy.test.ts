...
describe("shouldShowWorktreeSetupCallout", () => {
  it("shows the callout when thoth config was read and setup commands are missing", () => {
  ...
  it("does not show the callout when reading thoth config fails or has not completed", () => {
