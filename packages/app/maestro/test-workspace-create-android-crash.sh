...
OUT_DIR="/tmp/thoth-workspace-create-android-$(date +%s)"
...
echo "App id: $THOTH_MAESTRO_APP_ID"
echo "Android direct endpoint: $THOTH_MAESTRO_DIRECT_ENDPOINT"
echo "Daemon websocket: $THOTH_MAESTRO_DAEMON_WS_URL"
