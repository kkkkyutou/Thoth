...
export function WelcomeScreen({ onHostAdded }: WelcomeScreenProps) {
  ...
  const handleOpenThothSite = useCallback(() => {
    void openExternalUrl("https://thoth.sh");
  }, []);
      ...
      >
        <View style={styles.content}>
          ...
          <View style={styles.copyBlock}>
            ...
            {isNative ? (
              <Pressable style={styles.setupLink} onPress={handleOpenThothSite}>
                <Text style={styles.setupLinkText}>thoth.sh</Text>
