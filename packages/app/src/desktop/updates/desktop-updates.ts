...
const RELEASE_DOWNLOAD_BASE_URL = "https://github.com/thoth/thoth/releases/download";
...
export function buildMacAppleSiliconDownloadUrl(version: string | null | undefined): string | null {
  ...
  return `${RELEASE_DOWNLOAD_BASE_URL}/v${normalizedVersion}/Thoth-${normalizedVersion}-arm64.dmg`;
}
