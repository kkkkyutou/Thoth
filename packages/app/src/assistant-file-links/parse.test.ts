...
describe("parseAssistantFileLink", () => {
  ...
  it("keeps tilde hrefs as direct home-relative file targets", () => {
    expect(
      parseAssistantFileLink("~/.thoth/plans/file-preview.md", {
        workspaceRoot: "/Users/test/project",
      }),
    ).toEqual({
      raw: "~/.thoth/plans/file-preview.md",
      path: "~/.thoth/plans/file-preview.md",
      lineStart: undefined,
      lineEnd: undefined,
    });
    expect(
      parseAssistantFileLink("~/.thoth/plans/file-preview.md:12", {
        workspaceRoot: "/Users/test/project",
      }),
    ).toEqual({
      raw: "~/.thoth/plans/file-preview.md:12",
      path: "~/.thoth/plans/file-preview.md",
      lineStart: 12,
      lineEnd: undefined,
    });
...
describe("normalizeInlinePathTarget", () => {
  ...
  it("keeps tilde paths as home-relative file targets", () => {
    expect(
      normalizeInlinePathTarget("~/.thoth/plans/file-preview.md", "/Users/test/project"),
    ).toEqual({
      directory: "~/.thoth/plans",
      file: "~/.thoth/plans/file-preview.md",
    });
  });
