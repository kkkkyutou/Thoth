...
const existingProject = join(await mkdtemp(join(tmpdir(), "thoth-open-project-")), "project");
...
const previousDesktopCli = process.env.THOTH_DESKTOP_CLI;
process.env.THOTH_DESKTOP_CLI = "1";
...
process.env.THOTH_DESKTOP_CLI = previousDesktopCli;
