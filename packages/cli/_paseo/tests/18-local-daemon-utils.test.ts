...

{
  ...
  assert.strictEqual(resolveTcpHostFromListen("/tmp/thoth.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("unix:///tmp/thoth.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("pipe://\\\\.\\pipe\\thoth-managed-test"), null);
  assert.strictEqual(resolveTcpHostFromListen("\\\\.\\pipe\\thoth-managed-test"), null);
...

{
  ...
  assert.strictEqual(resolveTcpHostFromListen("C:\\Users\\foo\\.thoth\\thoth.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("D:\\project\\socket"), null);
  assert.strictEqual(resolveTcpHostFromListen("C:\\thoth.sock"), null);
