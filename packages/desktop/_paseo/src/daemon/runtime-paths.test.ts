...
describe("runtime-paths", () => {
  beforeEach(() => {
    ...
    setProcessRuntime({
      ...
      resourcesPath: "/Applications/Thoth.app/Contents/Resources",
    });
  });
  ...
  it("uses the macOS Helper executable for packaged daemon node launches", () => {
    expect(resolveNodeExecPath()).toBe(
      "/Applications/Thoth.app/Contents/Frameworks/Thoth Helper.app/Contents/MacOS/Thoth Helper",
    );
  });
});
