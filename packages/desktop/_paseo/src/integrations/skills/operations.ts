...
export const THOTH_SKILL_NAMES = [
  "thoth",
  "thoth-advisor",
  "thoth-chat",
  "thoth-committee",
...
function hasInstalledThothSkill(disks: readonly TargetSkills[]): boolean {
...
export async function getSkillsStatus(targets?: SkillTargets): Promise<SkillsStatus> {
  ...
  if (!hasInstalledThothSkill(disks)) return { state: "not-installed", ops };
