...
export function registerDialogHandlers(): void {
  ipcMain.handle("thoth:dialog:ask", async (event, message: string, options?: AskOptions) => {
  ...
  ipcMain.handle("thoth:dialog:open", async (event, options?: OpenOptions) => {
    const win = BrowserWindow.fromWebContents(event.sender);
