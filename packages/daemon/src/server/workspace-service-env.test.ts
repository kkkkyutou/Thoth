...
describe("buildWorkspaceServiceEnv", () => {
  ...
  it("builds default branch self and service URLs", () => {
    expect(
      ...
      HOST: "127.0.0.1",
      THOTH_PORT: "5173",
      THOTH_URL: "http://daemon--thoth.localhost:6767",
      THOTH_SERVICE_DAEMON_PORT: "5173",
      THOTH_SERVICE_DAEMON_URL: "http://daemon--thoth.localhost:6767",
    });
  });
  ...
  it("builds feature branch self and service URLs", () => {
    expect(
      ...
      HOST: "127.0.0.1",
      THOTH_PORT: "5173",
      THOTH_URL: "http://daemon--feature-x--thoth.localhost:6767",
      THOTH_SERVICE_DAEMON_PORT: "5173",
      THOTH_SERVICE_DAEMON_URL: "http://daemon--feature-x--thoth.localhost:6767",
    });
  });

  it("omits PORT while keeping THOTH_PORT", () => {
    ...
    expect(env.THOTH_PORT).toBe("5173");
  ...
  it("adds peer service ports and URLs", () => {
    expect(
      ...
      HOST: "127.0.0.1",
      THOTH_PORT: "5173",
      THOTH_URL: "http://web--feature-x--thoth.localhost:6767",
      THOTH_SERVICE_API_PORT: "4000",
      THOTH_SERVICE_API_URL: "http://api--feature-x--thoth.localhost:6767",
      THOTH_SERVICE_WEB_PORT: "5173",
      THOTH_SERVICE_WEB_URL: "http://web--feature-x--thoth.localhost:6767",
    });
  });
  ...
  it("uses public service URLs when a public base URL is configured", () => {
    expect(
      ...
      THOTH_URL: "https://web--feature-x--thoth.services.example.com",
      THOTH_SERVICE_API_URL: "https://api--feature-x--thoth.services.example.com",
      THOTH_SERVICE_WEB_URL: "https://web--feature-x--thoth.services.example.com",
    });
  });
