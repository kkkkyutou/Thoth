...
import type { AgentStreamEventPayload } from "@thoth/protocol/messages";
...
describe("client activity tracking", () => {
  ...
  beforeEach(async () => {
    ...
    daemon = await createTestThothDaemon({ pushNotificationSender: pushNotifications });
  });
