import { readThothConfigJson } from "./thoth-config-file.js";
import {
  ThothConfigSchema,
...
// owner replaces it wholesale via thoth.json metadataGeneration.<configKey>.instructions
...
async function readProjectMetadataOverrides(
...
): Promise<ThothMetadataGeneration | undefined> {
  ...
  try {
    ...
    return ThothConfigSchema.parse(json).metadataGeneration;
  } catch {
    return undefined;
  }
}
