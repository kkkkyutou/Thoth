...
import { createExternalProcessEnv, type ProcessEnvRecord } from "../thoth-env.js";
export {
...
} from "@thoth/protocol/provider-config";
import {
  ProviderOverrideSchema,
  ProviderOverridesSchema,
  ProviderRuntimeSettingsSchema,
...
// launched from inside Claude Code (e.g. by a Thoth agent), these leak into
