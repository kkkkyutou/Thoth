...
COMMAND_SPECS: tuple[CommandSpec, ...] = (
    ...
    CommandSpec(
        ...
        argument_hint="[--executor claude|codex] [--host claude|codex] [--detach] [--attach <run_id>] [--watch <run_id>] [--stop <run_id>] <task>",
        durable=True,
        ...
        interaction_gaps=("Task text or task id",),
    ),
    CommandSpec(
        command_id="loop",
        summary="Create one durable autonomous loop under the shared runtime and attach in the foreground by default.",
        argument_hint="[--executor claude|codex] [--host claude|codex] [--detach] [--attach <run_id>] [--resume <run_id>] [--watch <run_id>] [--stop <run_id>] [--goal <text>]",
        durable=True,
        supports_codex_executor=True,
        ...
        interaction_gaps=("Goal or mode details",),
    ),
    CommandSpec(
        command_id="review",
    ...
    CommandSpec(
        ...
        scope_can=("Update docs and plans",),
        scope_cannot=("Modify source code",),
