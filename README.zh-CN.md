...
<div align="center">
  ...
  <h2>🚀 最新动态</h2>
  <p><strong>v0.2.8.5 evidence-producing phase prompts</strong> · 缺 artifact、metric、log、receipt、benchmark output 或 service state 时，先作为执行问题继续生产证据，而不是直接写成最终解释</p>
