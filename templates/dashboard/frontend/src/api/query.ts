...
export const dashboardQueryKeys = {
  ...
  experiments: ['dashboard', 'experiments'] as const,
  experimentPrefix: ['dashboard', 'experiment'] as const,
  experiment: (experimentId: string) => ['dashboard', 'experiment', experimentId] as const,
